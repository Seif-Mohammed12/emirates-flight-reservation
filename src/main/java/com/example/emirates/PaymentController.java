...
public class PaymentController {
    ...
    private void setupCardIconUpdater() {
        cardNumberField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (cardType != null) {
                cardIcon.setImage(new Image(
                        Objects.requireNonNull(getClass().getResourceAsStream("/icons/" + cardType + ".png"))));
            } else {
    ...
    public void setFlightDetails(selectFlights.Flights flight, String selectedClass, int adults, int children,
            LocalDate departureDate, LocalDate returnDate, String selectedSeat,
            String updatedPrice, String selectedDestination, String selectedDeparture) {
    ...
    private VBox createAdditionalInfoSection() {
        ...
        Label departureDateLabel = new Label(
                "Departure Date: " + (departureDate != null ? departureDate.format(formatter) : "N/A"));
    ...
    private void handlePayButton() {
        ...
        BookingConfirmation.Booking booking = bookingConfirmation.createBooking(selectedFlight, passenger,
                departureDate, returnDate, totalAmount);
    ...
    private void handlegoBack() {
        try {
            ...
            BookingConfirmation.Passenger passenger = new BookingConfirmation.Passenger(passengerName, selectedSeat,
                    contactMethod, selectedClass, adults, children);

            bookingConfirmationController.setBookingDetails(selectedFlight, passenger, selectedSeat, selectedClass,
                    updatedPrice, departureDate, returnDate, adults, children, selectedDestination, selectedDeparture);
